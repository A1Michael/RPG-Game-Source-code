...
UCLASS()
class ACTORS_API AEnemy : public ACharacter
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION()
	virtual void AggroSphereonEndOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex);
